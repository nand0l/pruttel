Here is the rewritten version of the study guide, with the content made more cloud-agnostic and including references to Azure and Google Cloud Platform (GCP) services:
